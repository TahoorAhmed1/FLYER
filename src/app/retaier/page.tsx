...
export default function GroceryStoreExact() {
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="flex justify-between items-center px-6 py-4 bg-white shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-gray-400">1/28</span>
            <div className="ml-4">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search in Panda"
                className="pl-10 pr-12 py-2.5 border border-gray-200 rounded-lg w-64 text-sm focus:outline-none"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-gray-800 text-white p-1.5 rounded">
